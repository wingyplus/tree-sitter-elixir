...
enum {
  ...
  sym_list = 16,
  sym_tuple = 17,
  sym__trailing_comma_separator_elements = 18,
  sym_defmodule = 19,
  sym_do = 20,
  aux_sym_source_file_repeat1 = 21,
  aux_sym__trailing_comma_separator_elements_repeat1 = 22,
};
...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [5] = {
    ...
    [sym_list] = STATE(16),
    [sym_tuple] = STATE(16),
    [sym__trailing_comma_separator_elements] = STATE(25),
  ...
  [6] = {
    ...
    [sym_list] = STATE(16),
    [sym_tuple] = STATE(16),
    [sym__trailing_comma_separator_elements] = STATE(24),
    [sym_number] = ACTIONS(38),
    [sym_atom] = ACTIONS(38),
    [sym_string] = ACTIONS(38),
    [anon_sym_true] = ACTIONS(7),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__trailing_comma_separator_elements, 3),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple, 3),
  ...
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__trailing_comma_separator_elements, 2),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_do, 2),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_defmodule, 3),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__trailing_comma_separator_elements, 1),
  [64] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [66] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__trailing_comma_separator_elements_repeat1, 2),
  [70] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__trailing_comma_separator_elements_repeat1, 2), SHIFT_REPEAT(13),
